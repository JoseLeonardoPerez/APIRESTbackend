package com.joseLeonardo.java.springboot.backend.controllers;

import com.joseLeonardo.java.springboot.backend.entities.Product;
import org.springframework.http.HttpStatus;
import org.springframework.http.ResponseEntity;
import org.springframework.web.bind.annotation.*;
import com.joseLeonardo.java.springboot.backend.services.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<Product> delete(@PathVariable Long id){
        Optional<Product> deletedProduct = service.deleteById(id);
